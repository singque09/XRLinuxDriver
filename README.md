...
| -------- | ----------------- | -----------------   | ------------ | -------------- | --------------- | --------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| VITURE   | One<br/>One&nbsp;Lite<br/>Pro&nbsp;XR<br/>Luma<br/>Luma&nbsp;Pro<br/>Luma&nbsp;Ultra | :heavy_check_mark: | :+1: | :heavy_check_mark: | :heavy_check_mark: | [Official update site](https://static.viture.com/dfu-util/). Requires Chrome on Windows/Mac. | Official collaboration. [Closed source SDK]([https://www.viture.com/developer/viture-one-sdk-for-linux](https://www.viture.com/developer/glasses-sdk/glasses)). |
| VITURE   | Beast | :heavy_check_mark:&nbsp;XR&nbsp;driver&nbsp;v2.11.x<br/><br/>:heavy_check_mark:&nbsp;Breezy&nbsp;Desktop&nbsp;v2.11.x<br/><br/>:clock4:&nbsp;Decky&nbsp;XR&nbsp;Gaming | :clock4: Needs full SDK support.<br/>See notes for usage. | :heavy_check_mark: | :heavy_check_mark: | [Official update site](https://static.viture.com/dfu-util/). Requires Chrome on Windows/Mac. | Using official SDK with [custom fusion](https://github.com/wheaney/xrDeviceKit), exhibits slightly more drift and calibration time.<br/><br/>If pinned display is moving the wrong direction, try `~/.local/bin/xr_driver_cli --invert-y --invert-z` |
| VITURE   | Pro&nbsp;2&nbsp;XR | :heavy_check_mark:&nbsp;XR&nbsp;driver&nbsp;v2.11.x<br/><br/>:heavy_check_mark:&nbsp;Breezy&nbsp;Desktop&nbsp;v2.11.x<br/><br/>:clock4:&nbsp;Decky&nbsp;XR&nbsp;Gaming | :+1: | :heavy_check_mark: | :heavy_check_mark: | [Official update site](https://static.viture.com/dfu-util/). Requires Chrome on Windows/Mac. | Official collaboration. [Closed source SDK]([https://www.viture.com/developer/viture-one-sdk-for-linux](https://www.viture.com/developer/glasses-sdk/glasses)). |
| TCL/RayNeo | NXTWEAR&nbsp;S/S+<br/>Air&nbsp;2<br/>2s<br/>3s/Pro<br/>Air&nbsp;4&nbsp;Pro | :heavy_check_mark: | :+1: | :heavy_check_mark: |             |                                                       | Official collaboration, closed source SDK. Air&nbsp;4&nbsp;Pro holds GetHeadTrackerPose while parked after a 5s still gyro sample.                                                                                              |
...
| XREAL    | One<br/>One&nbsp;Pro<br/>1S | :heavy_check_mark:<br/><br/>**See notes before use** | :-1: | :heavy_check_mark: | :heavy_check_mark: | [Official update site](https://www.xreal.com/support/update/). Requires Chrome. | **Important** - Disable stabilizer/anchor features on glasses. Must be on latest firmware. |
| XREAL    | xbx&nbsp;a01+ | :heavy_check_mark:&nbsp;XR&nbsp;driver&nbsp;v2.11.x<br/><br/>:heavy_check_mark:&nbsp;Breezy&nbsp;Desktop&nbsp;v2.11.x<br/><br/>:clock4:&nbsp;Decky&nbsp;XR&nbsp;Gaming | :-1: | :heavy_check_mark: | :heavy_check_mark: | [Official update site](https://www.xreal.com/support/update/). Requires Chrome. | Unwilling to collaborate. Unofficial, open-source SDK. MCU bootstrap discovered by [taowen](https://github.com/taowen/ar-glass-lib). Present in the specified version but requires testing/tuning. |
